...
public class enter_challenge_a_league_adapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new enter_challenge_a_league_adapter.ListViewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        ((enter_challenge_a_league_adapter.ListViewHolder)holder).bindView(position);
    }
    ...
    private static class ListViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void bindView(int position){
            match_name.setText("IPL "+(position+1));
